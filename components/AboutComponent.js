	...
	return (
		<Card>
			...
			<Text style={{ margin: 10 }}>
				...
				traces its humble beginnings to The Frying Pan, a successful chain started by our
				CEO, Mr. Peter Pan, that featured for the first time the world's best cuisines in a
				pan.
			</Text>
		</Card>
	);
	...
	render() {
		...
		return (
			<ScrollView>
				<RenderCardHistory />
				<Card>
					<Card.Title>Corporate Leaderships</Card.Title>
					<FlatList
