	...
	return (
		<Card>
			...
			<Text style={{ margin: 10 }}>
				...
				next time you visit us. {"\n"}The restaurant traces its humble
				beginnings to The Frying Pan, a successful chain started by our
				CEO, Mr. Peter Pan, that featured for the first time the world's
